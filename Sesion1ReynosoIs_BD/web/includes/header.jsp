<%-- 
    Document   : header
    Created on : 15/11/2024, 08:10:38 PM
    Author     : cantt
--%>
...
<!-----------------------------/BOOTSTRAP----------------------------->
    ...
    <body style="background-color: #555">
        ...
        <div class="container">
            ...
            <div class="jumbotron">
                <center>
                    <h2>Sistemas de Gestion Reynoso</h2>
                    <img src="imagenes/logi.jpg" class="img img-responsive" alt="logo"/>
                </center>
